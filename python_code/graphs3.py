...
df1['delay'] = df1['time_consumed'] - df1['time_received']
df2['delay'] = df2['time_consumed'] - df2['time_received']
df3['delay'] = df3['time_consumed'] - df3['time_received']
df4['delay'] = df4['time_consumed'] - df4['time_received']
...
axes[0, 0].set_title('Consumer Delay ETHUSDT')
...
axes[0, 1].set_title('Consumer Delay AAPL')
...
axes[1, 0].set_title('Consumer delay AMZN')
...
axes[1, 1].set_title('Consumer Delay MSFT')
